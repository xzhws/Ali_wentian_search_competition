...
if __name__ == "__main__":
    ...
    data_check("./saved_model/simcse_sup_data_valid_NEZHA/query_embedding", file_type="query")
    print("*"*10, "Checking doc_embedding ...")
    data_check("./saved_model/simcse_sup_data_valid_NEZHA/doc_embedding", file_type="doc")
    ## 压缩embbeding
    ##  tar zcvf all_data_loss_valid.tar.gz doc_embedding query_embedding
